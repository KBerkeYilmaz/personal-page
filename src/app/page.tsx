...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    // Check local storage to see if the animation has already been played
    const hasAnimated = localStorage.getItem("hasAnimated");

    // If not, allow the animation to run and update local storage
    if (!hasAnimated) {
    ...
    <div>
      {!hasAnimationCompleted ? (
        ...
        <div>
          ...
          <div className="flex flex-col text-text text-lg mt-2">
            <h2>Hi, my name is Berke Yilmaz. &nbsp;</h2>
