    ...
    <>
      <div className="flex flex-col justify-center items-center gap-10  min-h-max overflow-y-auto scroll-m-10 scrollbar-transparent">
        ...
        <p className="text-white text-justify py-20">
          ...
          eius, dolore hic fuga debitis repudiandae quibusdam culpa facere
          explicabo, iusto molestias vitae quidem nostrum officiis. Possimus
          quisquam debitis dignissimos expedita!
        </p>
        <p className="text-white text-justify py-20">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus,
          eius, dolore hic fuga debitis repudiandae quibusdam culpa facere
