...
const Home: NextPage = () => {
  ...
  const [svgAxisX, setSvgAxisX] = useState(0);
  ...
  return (
    <header className="w-11/12 lg:w-full flex justify-start items-center">
      <div>
        <motion.svg
          initial={{ opacity: 0, x: 15 }}
          animate={{ opacity: 1, x: svgAxisX }}
        ...
        <div className="flex flex-col text-text text-sm lg:mt-2 justify-center items-center]">
          <motion.h2
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 1.2 }}
            className="my-2 text-center lg:text-justify xl:text-[1.6rem] xl:leading-normal"
          >
            Hi, my name is Berke Yilmaz. &nbsp;
          </motion.h2>

          <motion.p
            className="text-center lg:text-justify xl:text-[1.6rem] xl:leading-snug"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
