...
export default function App() {
  ...
  return (
    <div className="landing-page bg-background w-screen h-screen flex flex-col justify-center items-center">
      <main className="w-3/4 h-full flex flex-col justify-center gap-4">
        ...
        <div className="flex text-text text-xl text-justify">
          <motion.h2
          ...
          >
            ...
            from Izmir, Türkiye. I love to build pixel-perfect, beautiful interfaces with scalable, fast backends.  
          </motion.h2>
